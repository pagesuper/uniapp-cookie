...
var Cookie = /** @class */ (function () {
    ...
    Cookie.prototype.getDateTime = function (dateStr) {
        ...
        var rfc2822Match = dateStr.match(/^[A-Za-z]{3}, (\d{2}) ([A-Za-z]{3}) (\d{4}) (\d{2}:\d{2}:\d{2}) GMT$/);
        if (rfc2822Match) {
            var day = rfc2822Match[1], month = rfc2822Match[2], year = rfc2822Match[3], time = rfc2822Match[4];
